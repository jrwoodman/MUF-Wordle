...
: do-init ( str -- )
    ...
    "initialized" over "_words/status" addprop
    systime over "_words/init_time" addprop
    me@ intostr over "_words/init_by" addprop
